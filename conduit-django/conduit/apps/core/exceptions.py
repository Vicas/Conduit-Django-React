...
def core_exception_handler(exc, context):
    ...
    # the Django REST Framework deal with it
    exception_class = exc.__class__.__name__

    if exception_class in handlers:
        # If this exception is one that we can handle, deal with it. Otherwise
        # return the response generated earlier by the default exception handler
        print("debug, baby")
...
def _handle_generic_error(exc, context, response):
    ...
    # We take the response generated by the DRF and  wrap it in the errors key
    response.data = {
