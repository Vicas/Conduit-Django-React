...
# authentication.User tells Django we are referring to the User model in the authentication module
# This module is registered above in a setting called INSTALLED_APPS
